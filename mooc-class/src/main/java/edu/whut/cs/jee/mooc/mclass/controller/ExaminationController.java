...
public class ExaminationController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "exerciseId", value = "练习ID", dataTypeClass = Long.class)
    })
    ...
    @PreAuthorize("hasRole('TEACHER')")
    public void publish(@RequestParam(value = "lessonId", required = true) Long lessonId,
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "examinationRecordDto", value = "随堂测试答题卡", dataTypeClass = ExaminationRecordDto.class)
    })
